...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pedidos Recibidos</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    $select_products = $conn->prepare("SELECT p.*, c.name AS user_name, s.productName AS product_name, s.productPrice AS product_price, s.productImage1 AS product_image FROM orders p INNER JOIN users c ON p.userId = c.id INNER JOIN products s ON p.productId = s.id WHERE p.orderStatus=1" ); 
   ...
   if (!isset($ordersByUser[$userName])) {
    ...
    echo '<h1-6>Sin pedido<span class="badge bg-primary">Actuellemente</span></h1-6>';
}?>
