...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    $select_products = $conn->prepare("SELECT p.*, c.name AS user_name, c.contactno AS telephone_user, c.email AS email_user FROM messages p INNER JOIN users c ON p.userId = c.id WHERE (p.status=0) AND (userId=? OR findId=?)" ); 
