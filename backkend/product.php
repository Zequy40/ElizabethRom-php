...
<form method="post" action="">
    ...
    <button type="submit"class="btn btn-primary btn-sm"><?= ($showOnlyActive ? 'Mostrar todos' : 'Solo Activo'); ?></button>
</form>
  ...
  ?>
                  <tr>
                      ...
                      <td>
                        <ul class="list-inline">
                            <li >
                              ...
                              echo '<div class="product-img"><img src="dist/img/default-150x150.png" width="40" alt="User Image" class="img-size-50"></div>';
                          }else{
                              echo '<img alt="Avatar" class="img-size-50" src="img/product/'.$fetch_product['productImage1'].'">';
                          }?>
                      ...
                      <td>
                          <a>
                              ...
                              <br>
                              <small>
                              Creado <?= $fetch_product['postingDate']; ?>
                          </small>
    ...
    ?>
                  ...
                  <?php
                    ...
                    ?>
                    <h1-6>Sin producto <span class="badge bg-primary">de momento</span></h1-6>
                    <?php 
                    }
                     ?>
