    ...
    foreach ($ordersByUser as $userName => $userOrders) {
        ...
        echo '<td colspan="12"><strong>' . $userName . '</strong><br>';
         $userId = $userOrders[0]['userId'];
             ...
             echo'<div class="btn-group" role="group" aria-label="Third group"><a class="btn btn-primary btn-sm" href="orderInvoice.php?id=' . $userId . '"><i class="fas fa-solid fa-eye"></i> Toutes les Factures</a></div> <div class="btn-group" role="group" aria-label="Third group"><a class="btn btn-warning btn-sm" href="invoiceClient.php?id=' . $userId . '"><i class="fas fa-solid fa-file-invoice-dollar"></i>Créer Facture</a></div>';
