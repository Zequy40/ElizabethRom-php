...
<section class="contact_principal">
    ...
    <img class="image-contact" src="src/assets/contact.jpeg"/>
    <div class="divider">
		<div class="contact_notification">
            ...
            <div class="contact_notibody">Si deseas ponerte en contacto conmigo, utiliza los diferentes medios para comunicarte:
            ...
            <div class="contact_notibody">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-phone" viewBox="0 0 16 16">
                  ...
                  <p><a href="tel:+34 683 39 39 39">683 39 39 39</p></a></div>
            
                <div class="contact_contain">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
                        <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z"/>
                      </svg>
                  <p><a href="mailto:info@elirom.es">info@elirom.es</a></p></div>
                </div>
            </div>
            <div class="contact_card">
                <a href="#" class="contact_socialContainer contact_containerOne">
                ...
                <a href="#" class="contact_socialContainer contact_containerTwo">
                ...
                <a href="#" class="contact_socialContainer contact_containerThree">
