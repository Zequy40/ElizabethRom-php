...
<nav class="footer_footer">
    ...
    <a href="index.php"><div class="footer_containDiv <?php if ($currentPage == 'index.php') { echo 'actived'; } ?>">
    ...
    <a href="#"><div class="footer_containDiv <?php if ($currentPage == 'account.php') { echo 'actived'; } ?>">
    ...
    <div class="footer_containDiv" id="menu">
        <div class="footer_iconMenu <?php if ($currentPage == 'account.php') { echo 'linked'; } ?>" id="icon"><svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="footer_svg" viewBox="0 0 16 16">
